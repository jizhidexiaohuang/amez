    ...
    <div>
        ...
        <div v-if="pageType == 'list'" class="testWrap">
            ...
            <Form :model="cd" inline>
                ...
                <FormItem style="margin-bottom:10px;">
                    退款状态
                    <Select v-model="cd.returnStatus" style="width:140px">
                        <Option v-for="item in returnStatusList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                    </Select>
                </FormItem>
                <FormItem style="margin-bottom:10px;">
                    退款申请时间
            ...
            return {
                ...
                tableColumns1: [
                    ...
                    },
                    {
                        ...
                        width:120,
                        render:(h,params) =>{
                           let returnStatus = params.row.returnStatus;
                           let text = ''
                            if(returnStatus==0){
                                text = '———'
        ...
        methods: {
            ...
            getData (init) {
                ...
                if(vm.cd.orderStatus){
                    ...
                    }else if(vm.cd.orderStatus=='退款完成'){
                        ajaxData.returnStatus = 2;
                    }else{
                ...
                this.$http.post(
                    ...
                    // console.log(vm.table.tableData1)
                ...
                this.$refs.table.exportCsv({
                    ...
                    data: this.table.tableData1.filter((data, index) => {
                        ...
                        switch(data.returnStatus){
                            case 0:return data.returnStatus = '———'; break;
                            case 1:return data.returnStatus = '待卖家处理退款'; break;
                            case 2:return data.returnStatus = '退款成功'; break;
                            case 3:return data.returnStatus = '卖家拒绝退款'; break;
                        }
                    })
                });
                this.getData();
