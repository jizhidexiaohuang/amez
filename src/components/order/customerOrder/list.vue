<template>
    <div>
        <!-- 新增容器 -->
        <div v-if="pageType == 'add'"  class="testWrap" v-on:returnList="fnBackformAdd">新增</div>
        <!-- 编辑容器 -->
        <div v-if="pageType == 'edit'" class="testWrap" :editId="editId" v-on:returnList="fnBackformAdd">编辑</div>
        <!-- 详情容器 -->
    ...
    export default {
        ...
        methods: {
            ...
            getData () {
                ...
                let url = common.path+"storeChainBrand/front/findByPage?pageNo="+this.pageNun+'&pageSize='+this.size;
