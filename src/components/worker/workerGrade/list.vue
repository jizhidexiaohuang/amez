    ...
    <div>
        ...
        <div v-if="pageType == 'list'" class="testWrap">
            ...
            <Row style="margin-bottom:10px;">
                <Col span="10">
                    <Button v-if="operators.workerGrade" style="float:left;margin-right:10px;" @click.native="changePageType('grade')" type="success" icon="android-add">新增技师等级</Button>
                    <Button v-if="operators.workerRules" style="float:left;" @click.native="changePageType('rules')" type="primary" icon="android-add">成长规则设置</Button>
                </Col>
            </Row>
            <Table
