    ...
    <div>
        ...
        <div v-if="pageType == 'list'" class="testWrap">
            ...
            <Form :model="cd" inline>
                <Button v-if="operators.batchesOfMoney" style="float:left;margin-right:10px;" type="success" @click="makeMoney()">批量打款</Button>
